...
public enum SaiDesignLanguage {
    ...
    public static let title2: CGFloat = 24; public static let title2LineHeight: CGFloat = 29
}
...
public struct SaiText: View {
    ...
    public var body: some View {
        Text(text).font(.system(size: size, weight: .semibold)).lineSpacing(size * SaiDesignLanguage.title2LineHeight / SaiDesignLanguage.title2 - size).foregroundStyle(SaiDesignLanguage.textPrimary)
    }
}
