...
func allowBin(p string) bool {
	...
	switch p { case "scripts/agent-report", "scripts/agent-sync-drive", "scripts/agent-contract-pr-review", "scripts/agent-verify-caps", "prototypes/plugins/author/tests/delete-isolation.sh": return true }
	return false
}
