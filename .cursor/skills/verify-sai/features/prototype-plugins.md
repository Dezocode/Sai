...
- `proto-author-terminal` `scripts/verify-author-terminal-outcomes.py` (+ in-tree `prototypes/plugins/author/tests/terminal-outcomes.sh`) mechanical proof of delete + integrate-readiness + spin-off-readiness without architectural surgery.
...
- **Terminal outcomes.** ::py scripts/verify-author-terminal-outcomes.py
