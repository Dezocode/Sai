...
class Policy:
    ...
    def feature_contract(self) -> bool:
        ...
        shell_ok = has_kernel and calls(cs) == want and "os.StartProcess" not in cs and "syscall.Exec" not in cs and "syscall.ForkExec" not in cs and not re.search(r'(?:^|[\n;( ])\s*(?!import\b)(?:\w+|\.)\s+"os/exec"', cs)
