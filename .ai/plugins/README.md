...
3. Project skills under `.cursor/skills/` and `.agents/skills/` (SAI Custom Mode: `/lauren-mode`, alias `/lauren`)
...
4. Do **not** copy the upstream skill tree into `.cursor/skills/` (duplicate
   ...
   Custom Mode that **routes** to a plugin (`/lauren-mode` or `/lauren` → pstack) is
   allowed. See decisions `0005-lauren-mode-cloud-skills` and
   `0006-lauren-mode-fresh-cloud-discovery`.
