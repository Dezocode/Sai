...
2. **Generate your runtime name**: run `prototypes/plugins/cross-intercom/.sai/hooks/grokbot.sh name`. Owner-marked names win; otherwise you get a generated `sai.grunt-<hash>` fingerprint. If dezocode assigns you a handle, write it into `.sai/state/agent-name`.
